...
public class NetCDFImageReader extends GeoSpatialImageReader implements FileSetManager {
  ...
  @Override public List<Name> getCoveragesNames() {
    return Collections.unmodifiableList(coverages);
  }

  @Override public int getCoveragesNumber() {
  ...
  @Override public VariableAdapter getCoverageDescriptor(Name name) {
  ...
  @Override public void addFile(String filePath) {
  ...
  @Override public void removeFile(String filePath) {
